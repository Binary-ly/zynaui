const p = {
...
}, w = { name: b, tokens: x, swatches: z, styles: h }, m = "Corporate", f = {
  brand: "#1D3557",
  success: "#1A6B45",
  danger: "#A31621",
  info: "#2A5B8C"
...
}, y = { name: m, tokens: u, swatches: f, styles: v }, k = "Phosphor", F = {
  brand: "#FF9F0A",
  success: "#6EC96C",
  danger: "#FF4E4E",
  info: "#5BBFFF"
...
}, H = { name: R, tokens: W, swatches: V, styles: q }, J = "Atelier", K = {
  brand: "#B8920A",
  success: "#2D6A2D",
  danger: "#B03020",
  info: "#1A5C7A"
  ...
  "--zyna": "#B8920A",
  "--zyna-dark": "#8A6C00",
  // deep cast gold — rolled gold on base metal
  ...
  "--zp-success": "#2D6A2D",
  // sap green — balanced, organic
  "--zp-danger": "#B03020",
  // alizarin crimson — warm red lake
  "--zp-warning": "#C07000",
  // yellow ochre — deep warm amber
  "--zp-info": "#1A5C7A",
  // Prussian blue — archive, documentation
  ...
  "--bg": "#F5EFDF",
  "--bg2": "#EDE3C8",
  // warm parchment sidebar — deeper, clearly warm
  "--bg3": "#E3D5B0",
  "--border": "rgba(44,28,4,0.10)",
  "--border2": "rgba(44,28,4,0.05)",
  "--text": "#1C1208",
  "--text2": "#5C3D00",
  // warm amber-brown secondary text
  "--text3": "#8C6B20",
  // medium gold-brown tertiary
  ...
  "--z-duration-fast": "0.20s",
  // briefest luxury gesture
  "--z-duration-base": "0.38s",
  // slowest base in ZynaUI
  "--z-duration-slow": "0.52s",
  // slowest slow in ZynaUI
  "--z-duration-pulse": "6s",
  // slow editorial pulse
  "--z-ease-enter": "cubic-bezier(0.25, 0.46, 0.45, 0.94)",
  // silk unfurl
  ...
  'html[data-genre="atelier"]': {
    ...
    // slight left-side rounding on bar
...
}, Z = { name: J, tokens: Q, swatches: K, styles: U };
function _({ name: a, palette: r = {}, tokens: e = {}, styles: c = {}, extends: d }) {
  const n = d ?? o;
  return {
    name: a,
