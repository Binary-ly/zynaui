...
}, t = { name: p, tokens: i, swatches: s, styles: z }, g = "Cyberpunk", b = {
  brand: "#39FF14",
  success: "#39FF14",
  danger: "#FF073A",
  info: "#7B61FF"
...
}, w = { name: g, tokens: x, swatches: b, styles: h }, u = "Corporate", m = {
  brand: "#1D3557",
  success: "#1A6B45",
  danger: "#A31621",
  info: "#2A5B8C"
...
}, f = { name: u, tokens: v, swatches: m, styles: y }, k = "Phosphor", F = {
  brand: "#FF9F0A",
  success: "#6EC96C",
  danger: "#FF4E4E",
  info: "#5BBFFF"
...
}, A = { name: k, tokens: $, swatches: F, styles: E };
function C({ name: a, palette: r = {}, tokens: e = {}, styles: c = {}, extends: d }) {
  const n = d ?? t;
  return {
    name: a,
