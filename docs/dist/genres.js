...
}, y = { name: m, tokens: v, swatches: u, styles: f }, k = "Phosphor", F = {
  brand: "#FF9F0A",
  success: "#6EC96C",
  danger: "#FF4E4E",
  info: "#5BBFFF"
...
}, $ = { name: k, tokens: E, swatches: F, styles: A }, C = "Military", B = {
  brand: "#8B9E4B",
  success: "#5B8A3C",
  danger: "#CC3300",
  info: "#4A7FA5"
...
}, Y = { name: C, tokens: D, swatches: B, styles: I }, j = "Blueprint", M = {
  brand: "#1B3A6B",
  success: "#1A6B3A",
  danger: "#C0392B",
  info: "#2456A4"
...
}, G = { name: j, tokens: N, swatches: M, styles: S };
function P({ name: a, palette: r = {}, tokens: e = {}, styles: c = {}, extends: d }) {
  const n = d ?? o;
  return {
    name: a,
