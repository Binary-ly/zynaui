...
}, D = { name: k, tokens: E, swatches: F, styles: A }, C = "Military", $ = {
  brand: "#8B9E4B",
  success: "#5B8A3C",
  danger: "#CC3300",
  info: "#4A7FA5"
...
}, j = { name: C, tokens: B, swatches: $, styles: I }, X = "Blueprint", Y = {
  brand: "#1B3A6B",
  success: "#1A6B3A",
  danger: "#C0392B",
  info: "#2456A4"
...
}, S = { name: X, tokens: M, swatches: Y, styles: N }, G = "Washi", P = {
  brand: "#C93C23",
  success: "#2D6B3C",
  danger: "#9B1A0A",
  info: "#3A6B8A"
...
}, R = { name: G, tokens: O, swatches: P, styles: T };
function L({ name: a, palette: r = {}, tokens: e = {}, styles: c = {}, extends: d }) {
  const n = d ?? o;
  return {
    name: a,
