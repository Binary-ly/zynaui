...
export const tokens = {
  ...
  '--z-alert-border':          '1px solid color-mix(in srgb, var(--alert-bar-color) 35%, transparent)',
  '--z-alert-prefix-opacity': '0.55',
  '--z-alert-bar-glow':        '0 0 14px var(--alert-bar-color), 0 0 30px color-mix(in srgb, var(--alert-bar-color) 40%, transparent)',
  ...
  '--z-card-border-color':          'color-mix(in srgb, var(--zyna) 60%, transparent)',
  '--z-card-shadow':                '0 0 0 1px color-mix(in srgb, var(--zyna) 25%, transparent), 0 8px 32px rgba(0,0,0,0.6)',
  '--z-card-bar-height':            '3px',
  '--z-card-bar-bg':                'var(--zyna)',
  '--z-card-bar-shadow':            '0 0 14px var(--zyna), 0 0 32px color-mix(in srgb, var(--zyna) 50%, transparent)',
  '--z-card-header-bg':             'color-mix(in srgb, var(--zyna) 10%, transparent)',
  '--z-card-header-border':         'color-mix(in srgb, var(--zyna) 30%, transparent)',
  '--z-card-header-color':          'var(--zyna)',
  '--z-card-header-letter-spacing': '0.18em',
  '--z-card-header-text-shadow':    '0 0 10px color-mix(in srgb, var(--zyna) 60%, transparent)',
  ...
  '--z-card-title-text-shadow':     '0 0 18px color-mix(in srgb, var(--zyna) 22%, transparent)',
  '--z-card-glow-duration':         '5s',
  // Default glow colours applied to every .card so .card-glow pulses in neon automatically
  '--z-card-default-glow-lo':       'color-mix(in srgb, var(--zyna) 8%, transparent)',
  '--z-card-default-glow-hi':       'color-mix(in srgb, var(--zyna) 22%, transparent)',

  // ── Docs chrome ─────────────────────────────────────────────────────────────
  '--z-topbar-border':         'color-mix(in srgb, var(--zyna) 40%, transparent)',
  '--z-topbar-glow':           '0 1px 0 color-mix(in srgb, var(--zyna) 20%, transparent), 0 2px 14px color-mix(in srgb, var(--zyna) 10%, transparent)',
  '--z-sidebar-active-shadow': 'inset 3px 0 0 var(--zyna), inset 6px 0 0 color-mix(in srgb, var(--zyna) 30%, transparent)',
}
...
export const styles = {
  ...
  'html[data-genre="cyberpunk"] .badge-primary': {
    '--badge-bg':   'color-mix(in srgb, var(--zyna) 20%, transparent)',
    '--badge-glow': 'drop-shadow(0 0 8px color-mix(in srgb, var(--zyna) 70%, transparent)) drop-shadow(0 0 20px color-mix(in srgb, var(--zyna) 28%, transparent))',
  },
  'html[data-genre="cyberpunk"] .badge-success': {
    '--badge-bg':   'color-mix(in srgb, var(--z-color-success) 18%, transparent)',
    '--badge-glow': 'drop-shadow(0 0 8px color-mix(in srgb, var(--z-color-success) 70%, transparent)) drop-shadow(0 0 18px color-mix(in srgb, var(--z-color-success) 28%, transparent))',
  },
  'html[data-genre="cyberpunk"] .badge-danger': {
    '--badge-bg':   'color-mix(in srgb, var(--z-color-danger) 18%, transparent)',
    '--badge-glow': 'drop-shadow(0 0 8px color-mix(in srgb, var(--z-color-danger) 70%, transparent)) drop-shadow(0 0 18px color-mix(in srgb, var(--z-color-danger) 28%, transparent))',
  },
  'html[data-genre="cyberpunk"] .badge-warning': {
    '--badge-bg':   'color-mix(in srgb, var(--z-color-warning) 18%, transparent)',
    '--badge-glow': 'drop-shadow(0 0 8px color-mix(in srgb, var(--z-color-warning) 65%, transparent)) drop-shadow(0 0 16px color-mix(in srgb, var(--z-color-warning) 25%, transparent))',
  },
  'html[data-genre="cyberpunk"] .badge-info': {
    '--badge-bg':   'color-mix(in srgb, var(--z-color-info) 18%, transparent)',
    '--badge-glow': 'drop-shadow(0 0 8px color-mix(in srgb, var(--z-color-info) 70%, transparent)) drop-shadow(0 0 18px color-mix(in srgb, var(--z-color-info) 28%, transparent))',
  },
  'html[data-genre="cyberpunk"] .badge-secondary': {
    '--badge-bg':   'color-mix(in srgb, var(--zyna) 10%, transparent)',
    '--badge-glow': 'drop-shadow(0 0 6px color-mix(in srgb, var(--zyna) 45%, transparent))',
  },
  ...
  'html[data-genre="cyberpunk"] body::before': {
    ...
    zIndex: '0',
    pointerEvents: 'none',
    background: 'repeating-linear-gradient(0deg, transparent, transparent 2px, color-mix(in srgb, var(--zyna) 4.5%, transparent) 2px, color-mix(in srgb, var(--zyna) 4.5%, transparent) 3px)',
  },
}
